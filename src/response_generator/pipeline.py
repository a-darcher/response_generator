"""
pipeline.py — specify the parameters for a set of simulations, 
run the generator with the specified parameters, and save the resulting 
simulations as a pandas DataFrame at the given location. 
